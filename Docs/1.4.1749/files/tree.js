...
var licons = {
        'target': 'content',
        'ic_e'  : 'files/img/tree/0.gif',
        'ic_l'  : 'files/img/tree/90.gif',
        'ic_2'  : 'files/img/tree/91.gif',
        'ic_3'  : 'files/img/tree/92.gif',
        'ic_4'  : 'files/img/tree/99.gif',
        'ic_18' : 'files/img/tree/93.gif',
        'ic_19' : 'files/img/tree/94.gif',
        'ic_20' : 'files/img/tree/97.gif',
        'ic_26' : 'files/img/tree/95.gif',
        'ic_27' : 'files/img/tree/96.gif',
        'ic_28' : 'files/img/tree/98.gif'
};
